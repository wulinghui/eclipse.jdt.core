...
public YieldStatement(char[] label, int sourceStart, int e) {
	this(null, label, sourceStart, e);
}
public YieldStatement(Expression exp, char[] label, int sourceStart, int e) {
